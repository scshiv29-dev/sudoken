      ...
      <ScrollArea className="h-[60vh] border rounded-md p-4">
        <div className="space-y-4">
          ...
          <section>
            ...
            <p>Welcome to Sudoken. By accessing or using our application ("the app"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree with any part of these Terms, you must discontinue use of the app immediately.</p>
          </section>
          ...
          <section>
            ...
            <p>The app is provided on an "as is" and "as available" basis. We make no warranties or representations of any kind, whether express or implied, regarding the operation or availability of the app, or the accuracy of the information provided.</p>
          </section>
