      ...
      <ScrollArea className="h-[60vh] border rounded-md p-4">
        <div className="space-y-4">
          ...
          <section>
            ...
            <p>By accessing or using Sudoken ("the app"), you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must discontinue use of the app immediately.</p>
          </section>
          ...
          <section>
            ...
            <p>Sudoken is provided on an "as is" and "as available" basis. We make no warranties, express or implied, about the functionality or availability of the app, including any potential errors or interruptions.</p>
          </section>
